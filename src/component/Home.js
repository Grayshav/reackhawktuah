            ...
            <div id="carouselId" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="carousel-item active">
                        <img src={`${process.env.PUBLIC_URL}/dashboard/img/carousel-1.jpg`} class="img-fluid" alt="Image" />
                ...
                <div class="row g-5">
                    <div class="col-xl-5 wow fadeInLeft" data-wow-delay="0.1s">
                        <div class="bg-light rounded">
                            <img src="img/about-2.png" class="img-fluid w-100" style={{ marginBottom: '-7px' }} alt="Image" />
                            <img src="img/about-3.jpg" class="img-fluid w-100 border-bottom border-5 border-primary" style={{ borderTopRightRadius: '300px', borderTopLeftRadius: '300px' }} alt="Image" />
                        </div>
                    </div>
                            ...
                            <div class="col-8 col-md-9">
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    <div class="d-flex flex-column justify-content-center">
                                        ...
                                        <span class="text-secondary fw-bold fs-5" style={{ letterSpacing: '2px' }}>Free: +0123 456 7890</span>
                                    </div>
                                </div>
                            </div>
                        </div>
